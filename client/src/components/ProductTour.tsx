...
const STEPS: Step[] = [
  ...
  { sel: '[data-tour="/portfolio"]', title: 'Portfolio', body: 'Track holdings, realised & unrealised P&L, sector allocation, XIRR/CAGR, and your new Portfolio Health card — Nifty benchmark, drawdown and risk alerts.' },
  ...
  { sel: '[data-tour="/algo"]', title: 'Algo Trade', body: 'Define entry/exit rules or let the AI scan and execute trades for you based on your risk profile.' },
