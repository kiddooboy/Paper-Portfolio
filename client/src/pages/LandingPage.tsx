    ...
    <>
      <style>{`
        ...
        .lp-root {
          ...
          /* overflow-x hidden forces overflow-y to compute as auto, turning
             this into a scroll container that traps the page scroll. clip
             clips horizontally while leaving vertical scrolling on the body. */
          overflow-x: clip;
          overflow-y: visible;
          min-height: 100vh;
        }
