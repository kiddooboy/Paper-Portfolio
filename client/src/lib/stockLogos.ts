...
export const STOCK_DOMAINS: Record<string, string> = {
  ...
  SAIL: 'sail.co.in',
  PEL: 'piramalfoundation.org',
  SBICARD: 'sbicard.com',
  LICHSGFIN: 'lichsgfin.com',
