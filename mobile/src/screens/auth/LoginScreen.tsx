...
GoogleSignin.configure({
  webClientId: '563092918942-gtthtdn41p3p8ev2narfguaihn12f14m.apps.googleusercontent.com',
});
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.inner} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.subtitle}>Sign in to your Paper Portfolio account</Text>
